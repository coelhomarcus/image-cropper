...
export function CropPreviewModal({ preview, originalSize, onClose, onDownload }: CropPreviewModalProps) {
  return (
    <div 
      ...
      <div className="max-w-4xl w-full max-h-full overflow-auto">
        <div className="bg-[#16171f] rounded-lg border border-[#2d2e3a] p-4 md:p-6 relative">
          ...
          <div className="text-center mb-4 md:mb-6">
            <h3 className="text-base md:text-lg font-semibold text-[#f3f4f6]">Recortado com sucesso!</h3>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 md:gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 w-full">
              <div className="flex items-center gap-2 bg-[#1e1f2a] px-3 md:px-4 py-2 rounded-lg">
                ...
                <span className="text-xs md:text-sm text-[#6b7280]">Original:</span>
                <span className="text-xs md:text-sm font-medium text-[#9ca3af]">{formatFileSize(originalSize)}</span>
              </div>
              <div className="flex items-center gap-2 bg-green-500/20 px-3 md:px-4 py-2 rounded-lg">
                ...
                <span className="text-xs md:text-sm font-semibold text-green-300">{preview.sizeFormatted}</span>
              </div>
            </div>
