    ...
    <header className="bg-[#16171f] border-b border-[#2d2e3a] px-3 md:px-4 py-2 md:py-3 flex items-center justify-between shrink-0">
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-base md:text-lg font-semibold text-[#f3f4f6] hidden sm:inline">Recortar Imagem</span>
        </div>
      ...
      {/* Right side */}
      <div className="flex items-center gap-2 md:gap-4">
        <a href="https://marcuscoelho.com" target="_blank" rel="noopener noreferrer" className="hidden sm:inline text-xs text-[#6b7280] hover:text-[#3b82f6] transition-colors">
          @coelhomarcus
        </a>
        <button onClick={onBack} className="flex items-center gap-1.5 px-2 md:px-3 py-1.5 rounded-md text-xs font-medium bg-red-500/10 text-red-400 hover:bg-red-500/20 transition-colors">
